...
import com.stone.store.play.shop.payload.ShopRes.CartItemDto;
...
public class CartQuerydslRepository extends Querydsl4RepositorySupport {
    ...
    public List<CartItemDto> findCartItemsByUser(User user) {
        return select(Projections.fields(CartItemDto.class,
